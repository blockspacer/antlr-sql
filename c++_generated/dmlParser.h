...
public:
  enum {
    ...
    T__26 = 27, T__27 = 28, T__28 = 29, T__29 = 30, T__30 = 31, WORD = 32, 
    ALPHA = 33, DIGIT = 34, EQUAL = 35, NOTEQUAL = 36, GREATERTHAN = 37, 
    LESSTHAN = 38, GREATERTHANOREQUAL = 39, LESSTHANOREQUAL = 40, WS = 41
  };
  ...
  enum {
    ...
    RuleUpdate_cmd = 28, RuleInsert_cmd = 29, RuleDelete_cmd = 30, RuleTyped_attribute_list = 31, 
    RuleType = 32, RuleInteger = 33
  };
